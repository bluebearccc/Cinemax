...
import com.bluebear.cinemax.service.BookingServiceSF;
...
public class BookingController {
    ...
    public BookingController(EmailService emailService, BookingServiceSF bookingServiceSF, TheaterStockRepository theaterStockRepo, ScheduleRepository scheduleRepository, RoomRepository roomRepository, SeatRepository seatRepository, PromotionRepository promotionRepository, VnpayService vnpayService, InvoiceRepository invoiceRepo) {
        this.emailService = emailService;
        this.bookingServiceSF = bookingServiceSF;
    ...
    public String showBookingPage(@RequestParam("scheduleId") Integer scheduleId,
        ...
        List<SeatDTO> seats = bookingServiceSF.getSeatsWithStatus(roomId, scheduleId);
    ...
    public String handleBookingStep1(@RequestParam("scheduleId") Integer scheduleId,
        ...
        try {
            ...
            Double totalAmount = bookingServiceSF.calculateTotalAmount(scheduleId, seatIds, promotionCode);

            // Chuẩn bị dữ liệu cho bước 2
            List<TheaterStockDTO> combos = bookingServiceSF.getAvailableCombos();
    ...
    public String handleBookingStep2(@RequestParam("scheduleId") Integer scheduleId,
                                     ...
                                     HttpSession session) {
        try {
            Map<Integer, Integer> comboQuantities = bookingServiceSF.extractComboQuantities(allParams);
            BookingPreviewDTO previewData = bookingServiceSF.prepareBookingPreview(scheduleId, roomId, seatIds, promotionCode, comboQuantities);
    ...
    public String confirmBookingAndRedirectToVnpay(@RequestParam("scheduleId") Integer scheduleId,
        ...
        try {
            ...
            InvoiceDTO invoice = bookingServiceSF.bookSeatsAndCombos(scheduleId,customerId, seatIds, promotionCode, comboQuantities);
    ...
    public Map<String, Object> checkPromotion(@RequestParam("code") String code,
        ...
        return bookingServiceSF.checkPromotionCode(code, totalAmount);
    }
    ...
    public Map<String, Object> applyPromotion(@RequestParam("code") String code,
                                              @RequestParam("totalAmount") Double totalAmount) {
        return bookingServiceSF.applyPromotionCode(code, totalAmount);
    }
