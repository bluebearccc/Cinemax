...
public class MovieService {
    ...
    private MovieDTO convertToDTO(Movie movie) {
        ...
        dto.setMovieID(movie.getMovieID()); // Không cần cast vì đã là Integer
        ...
        // Sửa ternary operator - thêm else clause
        dto.setStatus(movie.getStatus() != null ? movie.getStatus() : Movie_Status.Active);

        // Convert to List<GenreDTO> thay vì List<String>
        dto.setGenres(movie.getGenres() != null && !movie.getGenres().isEmpty() ?
            movie.getGenres().stream()
                .map(this::convertToGenreDTO)
                .collect(Collectors.toList()) :
            Collections.emptyList());

        // Convert to List<ActorDTO> thay vì List<String>
        dto.setActors(movie.getActors() != null && !movie.getActors().isEmpty() ?
    ...
    // Helper method để convert Genre sang GenreDTO
    ...
    // Helper method để convert Actor sang ActorDTO
    private ActorDTO convertToActorDTO(Actor actor) {
        ...
        return ActorDTO.builder()
            ...
            .movies(actor.getMovies() != null && !actor.getMovies().isEmpty() ?
