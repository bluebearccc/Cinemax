...
public class EmailService {
    ...
    @Autowired
    private JavaMailSender mailSender; // Cần cấu hình bean này trong project

    @Autowired
    private InvoiceRepository invoiceRepository; // Giả sử bạn có repository này

    /**
     * Gửi email thông báo hủy vé do ghế không khả dụng
     * @param bookings Danh sách các vé trong tương lai bị ảnh hưởng
     */
