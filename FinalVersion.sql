...
VALUES ('Movie 0', 'Description 0', 'img0.jpg', 'Studio 0', 'Action', 90, 'trailer0.mp4', 8, 'Actor A, Actor B');
INSERT INTO Movie (MovieName, Description, Image, Studio, Genre, Duration, Trailer, MovieRate, Actor)
VALUES ('Movie 1', 'Description 1', 'img1.jpg', 'Studio 1', 'Comedy', 100, 'trailer1.mp4', 6, 'Actor A, Actor B');
INSERT INTO Movie (MovieName, Description, Image, Studio, Genre, Duration, Trailer, MovieRate, Actor)
VALUES ('Movie 2', 'Description 2', 'img2.jpg', 'Studio 2', 'Drama', 110, 'trailer2.mp4', 7, 'Actor A, Actor B');
INSERT INTO Movie (MovieName, Description, Image, Studio, Genre, Duration, Trailer, MovieRate, Actor)
VALUES ('Movie 3', 'Description 3', 'img3.jpg', 'Studio 3', 'Horror', 120, 'trailer3.mp4', 9, 'Actor A, Actor B');
INSERT INTO Movie (MovieName, Description, Image, Studio, Genre, Duration, Trailer, MovieRate, Actor)
VALUES ('Movie 4', 'Description 4', 'img4.jpg', 'Studio 4', 'Sci-Fi', 130, 'trailer4.mp4', 5, 'Actor A, Actor B');
...
VALUES ('Movie', 1, 'Old Movie 1', 'New Movie 1', 'Update', 1, GETDATE());
INSERT INTO History (TableName, RecordID, OldValue, NewValue, Action, AccountID, UpdatedAt)
VALUES ('Movie', 2, 'Old Movie 2', 'New Movie 2', 'Update', 1, GETDATE());
INSERT INTO History (TableName, RecordID, OldValue, NewValue, Action, AccountID, UpdatedAt)
VALUES ('Movie', 3, 'Old Movie 3', 'New Movie 3', 'Update', 1, GETDATE());
